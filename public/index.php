...
<head>
    ...
    <!-- Ionicons (unused, but kept for compatibility) -->
...
<body class="flex flex-col min-h-screen bg-gradient-to-br from-[#CCEBD5]/90 to-[#B0CFCF]/90 bg-fixed overflow-x-hidden">
    ...
    <main class="flex-grow pt-16">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 mt-6 mb-10">
            ...
            <!-- Sensor Status & Overview (Left 40% / Right 60%) -->
    ...
    <section class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Chart Grid Section (Temperature and Humidity) -->
        ...
        <!-- Chart Grid Section (Gas and Ammonia) -->
        <div class="grid grid-cols-1 gap-6 mb-10">
            <div class="bg-white/90 rounded-3xl shadow-lg p-6 flex flex-col justify-center items-center">
    ...
    <section class="container mx-auto px-4 sm:px-6 lg:px-8 mt-10 mb-10">
        ...
        <!-- Control Panel Header & Logs Button -->
...
async function loadMoistureChart() {
    try {
        ...
        if (!Array.isArray(data) || data.length === 0) {
            console.warn("No data received for moisture chart.");
            return;
        }
...
document.addEventListener("DOMContentLoaded", () => {
    loadMoistureChart(); // First render right away
    setInterval(loadMoistureChart, 30000); // Update every 30s
});
</script>
...
async function loadGasAmmoniaChart() {
    try {
        // Since this file is in 'public', the fetch path should be '../functions/get_gas_ammonia_data.php'
...
<script>
    ...
    async function updateOverviewValues() {
        try {
            ...
            document.getElementById('avg-humid').textContent = Math.round(data.humidity || 0);
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        confirmResetBtn.addEventListener('click', async function() {
            try {
                ...
                // Note: The original code used alert(), which is forbidden. I'm leaving the console error here.
            }
        });
