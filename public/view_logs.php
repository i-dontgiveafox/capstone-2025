...
<body class="flex flex-col min-h-screen bg-gradient-to-br from-[#CCEBD5]/90 to-[#B0CFCF]/90 bg-fixed overflow-x-hidden text-gray-800">
    ...
    <thead class="hidden md:table-header-group">
        <tr class="bg-[#1e1e1e] text-white text-center text-xs font-semibold uppercase tracking-wider">
            <th class="px-6 py-4 rounded-tl-lg">Timestamp</th>
            <th class="px-6 py-4">Device Type</th>
            <th class="px-6 py-4 rounded-tr-lg">Event Description</th>
        </tr>
    </thead>

    <tbody id="logsTableBody" class="block md:table-row-group space-y-4 md:space-y-0">
        <?php
        ...
        ?>
            <tr class="bg-white/90 backdrop-blur-sm flex flex-col md:table-row rounded-xl shadow-lg md:shadow-none border border-white/50 md:border-b md:border-gray-200 p-4 md:p-0 relative">
                ...
                <td class="md:px-6 md:py-4 order-1 md:order-none flex justify-between md:table-cell text-center">
                ...
                <td class="md:px-6 md:py-4 order-3 md:order-none mt-3 md:mt-0 block md:table-cell text-center">
                    <span class="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-bold uppercase shadow-sm w-full md:w-auto justify-center md:justify-center <?php echo $badgeClass; ?>">
                        <i class='bx <?php echo $icon; ?> text-sm'></i> <?php echo $type; ?>
                    </span>
                </td>
                
                <td class="md:px-6 md:py-4 order-2 md:order-none mt-2 md:mt-0 block md:table-cell text-center">
        ...
        <?php 
            ...
            echo "<tr><td colspan='3' class='px-6 py-10 text-center text-gray-500 italic'>No logs found.</td></tr>";
        } 
        ?>
    </tbody>
</table>
